      ...
      <div class="signup" id="open">
         ...
         <div class="text" id="cloud">
            <p>
               ...
               فراوان جامعه و متخصصان را می طلبد تا با نرم افزارها شناخت بیستری را برای طراحان رایانه ای و فرهنگ پیشرو
         ...
         <div class="container">
            <div class="about-text">
               ...
               <p class="wow animated fadeIn">
                  نهال‌گشت ایرانیان یک شرکت هلدینگ در صنعت گردشگری است و با شرکت‌های زیر مجموعه و ساب برندهای مختلف در
                  اکثر بخش‌های گردشگری فعالیت می‌کند. هرکدام از این بخش‌ها برای رفاه حال باشگاه مشتریان 45,000 نفری
                  نهال‌گشت بوجود آمده‌اند؛ آژانس هواپیمایی و مسافرتی نهال گشت یکی از این بخش‌هاست که تورهای ارزان، لوکس،
   ...
   <section>
      <div class="views wow animated fadeIn" id="section-3">
         <div class="container">
            ...
            <p>
               برای درخواست تورهای ارزان قیمت، رزرو هتل، بلیط هواپیما – اتوبوس – قطار، تورهای لحظه آخری، تورهای خارجی و
      ...
      <div class="project-landing" id="section-4">
         <div class="wrapper">
            ...
            <div class="grid wow animated fadeIn">
               <figure>
                  <img src="assets/images/tour/mashhad.jpg" alt="">
                  <figcaption>
                     <h2>تور مشهد</h2>
                     <h4><i class="far fa-calendar-alt"></i>تاریخ رفت 26 فرودین</h4>
                     <h4><i class="far fa-clock"></i>اقامت 8 روز</h4>
                     <h4><i class="far fa-hospital"></i>هتل سه ستاره</h4>
                     <a href="#" class="more">نمایش کامل</a>
                  </figcaption>
               </figure>
               <figure>
                  <img src="assets/images/tour/shiraz.jpg" alt="">
                  <figcaption>
                     <h2>تور شیراز</h2>
                     <h4><i class="far fa-calendar-alt"></i>تاریخ رفت 26 فرودین</h4>
                     <h4><i class="far fa-clock"></i>اقامت 8 روز</h4>
               ...
               <figure>
                  <img src="assets/images/tour/esfahan.jpg" alt="">
                  <figcaption>
                     <h2>تور اصفهان</h2>
                     <h4><i class="far fa-calendar-alt"></i>تاریخ رفت 26 فرودین</h4>
                     <h4><i class="far fa-clock"></i>اقامت 8 روز</h4>
               ...
               <figure>
                  <img src="assets/images/tour/kish.jpg" alt="">
                  <figcaption>
                     <h2>تور کیش</h2>
                     <h4><i class="far fa-calendar-alt"></i>تاریخ رفت 26 فرودین</h4>
                     <h4><i class="far fa-clock"></i>اقامت 8 روز</h4>
                  ...
                  <div class="post">
                     <ul class="question">
                        <li id="q1">
                           ...
                           <ul id="answer1">
                              <li>امکان رزرو بلیط هواپیما از ماه‌ها قبل وجود دارد. اما گاهی اوقات قیمت بلیط هواپیما در
                                 روزهای
                                 نزدیک به پرواز ارزان‌تر می‌شود. بنابراین در صورتی که شرایطتان اجازه می‌دهد، رزرو آنلاین
                                 بلیط
                                 هواپیما را به روزهای نزدیک پرواز موکول کنید. البته اگر قصد سفر در ایام پرسفر نظیر
                                 تعطیلات را
                  ...
                  <div class="post">
                     <ul class="question">
                        <li id="q2">
                           ...
                           <ul id="answer2">
                              <li>هنگام تهیه بلیط از سایت ما خیالتان آسوده است که امکان بازگشت وجه شما وجود دارد میزان
                                 جریمه
         ...
         <div class="wrapper">
            ...
            <div id="owl-demo" class="wow animated fadeIn">
               <div class="item">
                  <a href="#">
                     <figure class="figurefx pushup">
                        ...
                        <figcaption>
                           <h2>تور مشهد</h2>
                           <h4>تاریخ رفت 26 فرودین<i class="far fa-calendar-alt"></i></h4>
                           <h4>اقامت 8 روز<i class="far fa-clock"></i></h4>
                           <h4>هتل سه ستاره<i class="far fa-hospital"></i></h4>
                        </figcaption>
                     </figure>
                  </a>
               </div>
               ...
               <div class="item">
                  <a href="#">
                     <figure class="figurefx pushup">
                        <img src="assets/images/tour/tabriz.jpg" alt="">
                        <figcaption>
                           <h2>تور تبریز</h2>
                           <h4>تاریخ رفت 26 فرودین<i class="far fa-calendar-alt"></i></h4>
                           <h4>اقامت 8 روز<i class="far fa-clock"></i></h4>
               ...
               <div class="item">
                  <a href="#">
                     <figure class="figurefx pushup">
                        <img src="assets/images/tour/gheshm.jpeg" alt="">
                        <figcaption>
                           <h2>تور قشم</h2>
                           <h4>تاریخ رفت 26 فرودین<i class="far fa-calendar-alt"></i></h4>
                           <h4>اقامت 8 روز<i class="far fa-clock"></i></h4>
